...
class JLNEditLeadScreen extends StatefulWidget {
  const JLNEditLeadScreen({super.key});

  @override
  State<JLNEditLeadScreen> createState() => _JLNEditLeadScreenState();
}

class _JLNEditLeadScreenState extends State<JLNEditLeadScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: "Job leads new Edit Lead"),
