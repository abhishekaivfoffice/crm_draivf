...
class JLNConvertToCustomerPage extends StatelessWidget {
  const JLNConvertToCustomerPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: "Job Lead new convert to customer"),
