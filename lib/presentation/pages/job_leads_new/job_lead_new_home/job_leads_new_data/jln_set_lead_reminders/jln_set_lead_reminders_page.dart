...
class JLNSetLeadRemindersPage extends StatelessWidget {
  const JLNSetLeadRemindersPage({super.key});

  @override
  Widget build(BuildContext context) {
    final setleadreminderprovider=Provider.of<JLNSetLeadRemindersProvider>(context);
    return Scaffold(
      appBar: CustomAppBar(title: "Job Lead New set lead reminders"),
