...
//course lead edit lead screen
class CourseEditLeadScreen extends StatefulWidget {
  const CourseEditLeadScreen({super.key});

  @override
  State<CourseEditLeadScreen> createState() => _CourseEditLeadScreenState();
}

class _CourseEditLeadScreenState extends State<CourseEditLeadScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: " course Edit Lead"),
