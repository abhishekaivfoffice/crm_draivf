...
//course lead reminder page
class CourseSetLeadRemindersPage extends StatelessWidget {
  const CourseSetLeadRemindersPage({super.key});

  @override
  Widget build(BuildContext context) {
    final setleadreminderprovider=Provider.of<INLSetLeadRemindersProvider>(context);
    return Scaffold(
      appBar: CustomAppBar(title: " Course set lead reminders"),
