...
// course lead add new task page
class CourseAddNewTaskPage extends StatelessWidget {
  const CourseAddNewTaskPage({super.key});

  @override
  Widget build(BuildContext context) {
    final addnewtaskprovider = Provider.of<InlAddNewTaskProvider>(context);
    return Scaffold(
      appBar: CustomAppBar(title: " Course Add New Task"),
