...
class JLAssignedMemberDetails extends StatelessWidget {
  final AssignedMember member;

  const JLAssignedMemberDetails({super.key, required this.member});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: "Job lead Assigned Profile"),
      body: Column(
        children: [
          Stack(
              ...
              children: [
                ListTile(
                  ...
                  trailing: CustomGradientButton(
                    ...
                    onPressed: () {
                      Get.toNamed(AppRoutes.jlassignedMemberProfileedithome);
                    },
                  ),
                  onTap: () {},
                ),
