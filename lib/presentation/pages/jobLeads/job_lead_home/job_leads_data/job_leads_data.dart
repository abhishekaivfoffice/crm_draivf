...
import 'package:crm_draivfmobileapp/presentation/pages/jobLeads/job_lead_home/job_leads_data/job_lead_data_profile.dart';
...
class JobLeadsData extends StatelessWidget {
  const JobLeadsData({super.key});
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    MaterialPageRoute(
                      builder: (context) => JOBLeadDataProfile(user: user),
                    ),
                  );
                },
                child: Padding(
