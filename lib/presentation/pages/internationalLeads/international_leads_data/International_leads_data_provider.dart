import 'package:crm_draivfmobileapp/data/models/assigned_members_model.dart'
    show AssignedMember, User;
import 'package:flutter/material.dart';

class InternationalLeadsDataProvider extends ChangeNotifier {
  int currentPage = 0;
  int pageSize = 10;
  ...
  //////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //////////////filter values
  final List<String> _filterpreferedlocation = [
    "Bangladesh",
    "Canada",
    "International",
    "Malaysia",
  ...
  List<String> get filterpreferredlocation => _filterpreferedlocation;

  //branches
  final List<String> _branches = ["International"];
  ...
  ////date filter
  final List<String> _filterdateFilter = ["Created", "Last Contact"];
  List<String> get filterdateFilter => _filterdateFilter;

  final TextEditingController dateRangeController = TextEditingController();

  String? _selectedFilterpreferredlocation;
  String? get selectedFilterPreferredLocation =>
      _selectedFilterpreferredlocation;

  String? _selectedFilterBranches;
  String? get selectedFilterBranches => _selectedFilterBranches;
  ...
  //setzones
  void setFilterPreferredLocation(String? preferredlocation) {
    _selectedFilterpreferredlocation = preferredlocation;
    notifyListeners();
  }

  void setFilterBranches(String? branches) {
