...
import 'package:crm_draivfmobileapp/presentation/pages/internationalLeads/international_lead_assigned_member_profile/international_lead_assigned_member_profile/international_lead_assigned_member_profile.dart';
...
class InternationalLeadDataProfile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: "International lead Data detailed page"),
      body: Padding(
                                  ...
                                  child: InkWell(
                                    onTap: () {
                                      Navigator.push(
                                        ...
                                        MaterialPageRoute(
                                          builder:
                                              (_) => InternationalLeadAssignedMemberProfile(
                                                member: m,
                                              ),
                                        ),
                                      );
