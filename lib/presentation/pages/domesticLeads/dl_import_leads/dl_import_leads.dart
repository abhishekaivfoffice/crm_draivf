...
import 'package:crm_draivfmobileapp/presentation/pages/domesticLeads/dl_import_leads/dl_import_lead_text.dart';
...
class DLImportLeads extends StatelessWidget {
  DLImportLeads({super.key});
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      children: [
                        _buildRichText([
                          DLImportLeadTexts.point1Part1,
                          DLImportLeadTexts.utf8Part,
                          DLImportLeadTexts.point1Part2,
                        ]),
                        const SizedBox(height: 8),
                        _buildRichText([
                          DLImportLeadTexts.point2Part1,
                          DLImportLeadTexts.dateFormat,
                          DLImportLeadTexts.point2Part2,
                        ]),
                        const SizedBox(height: 8),
                        _buildRichText([
                          DLImportLeadTexts.point3Part1,
                          DLImportLeadTexts.uniqueValidation,
                          DLImportLeadTexts.point3Part2,
                        ]),
                        const SizedBox(height: 6),
                        _buildRichText([DLImportLeadTexts.leadEmail]),
                        _buildRichText([DLImportLeadTexts.leadPhone]),
                        const SizedBox(height: 12),
                        _buildRichText([DLImportLeadTexts.note]),
                      ],
                    ),
                  ),
                ),
