...
class DLAssignedMemberProfile extends StatelessWidget {
  final AssignedMember member;

  const DLAssignedMemberProfile({super.key, required this.member});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: "domestic lead Assigned Profile"),
      body: Column(
        children: [
          Stack(
