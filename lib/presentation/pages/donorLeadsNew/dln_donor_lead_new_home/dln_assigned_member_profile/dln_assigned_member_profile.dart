...
class DLNAssignedMemberDetails extends StatelessWidget {
  ...
  const DLNAssignedMemberDetails({super.key, required this.member});

  @override
  Widget build(BuildContext context) {
    final dlnassignedmemberprofileprovider =
        Provider.of<DLNAssignedMemberProfileProvider>(context);
    return Scaffold(
      drawer: TabletMobileDrawer(),
      appBar: CustomAppBar(title: "DLN Assigned Profile"),
      body: Column(
        children: [
          Stack(
                          ...
                          child: Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: DropdownButton<int>(
                                value: dlnassignedmemberprofileprovider.pageSize,
                                ...
                                onChanged: (val) {
                                  if (val != null) {
                                    dlnassignedmemberprofileprovider.setPageSize(
                                      val,
                                    );
                                  }
                                },
                          ...
                          child: Padding(
                            ...
                            child: SizedBox(
                              ...
                              child: DropdownButton<String>(
                                value:
                                    dlnassignedmemberprofileprovider
                                        .selectedAction,
                                underline: const SizedBox(),
                                hint: const Text(
                                  " Export",
                                ...
                                items:
                                    dlnassignedmemberprofileprovider.actionItems
                                        .map((e) {
                                          return DropdownMenuItem(
                                            value: e,
                                            child: Text(
