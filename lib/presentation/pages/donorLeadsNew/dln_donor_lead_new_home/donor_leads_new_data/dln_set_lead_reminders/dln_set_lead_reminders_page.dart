...
import 'package:crm_draivfmobileapp/provider/donor_lead_new_provider/dln_set_lead_reminders_provider.dart';
...
class DLNSetLeadRemindersPage extends StatelessWidget {
  const DLNSetLeadRemindersPage({super.key});

  @override
  Widget build(BuildContext context) {
    final setleadreminderprovider=Provider.of<DLNSetLeadRemindersProvider>(context);
    return Scaffold(
