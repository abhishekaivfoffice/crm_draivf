...
import 'package:crm_draivfmobileapp/presentation/pages/donorLeadsNew/dln_donor_lead_new_home/dln_edit_leads/dln_edit_donor_eighth_page.dart';
...
class DLNEditDonorDetailsSeventhScreen extends StatefulWidget {
  DLNEditDonorDetailsSeventhScreen({super.key});

  @override
  State<DLNEditDonorDetailsSeventhScreen> createState() => _DLNEditDonorDetailsSeventhScreenState();
}

class _DLNEditDonorDetailsSeventhScreenState extends State<DLNEditDonorDetailsSeventhScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: "DLN Edit Donor Lead 7th screen"),
                          ...
                          child: CustomGradientButton(
                            ...
                            Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder:
                                      (context) =>
                                          DLNEditDonorDetailsEighthhScreen(),
                                ),
                              );
                            },
                          ),
