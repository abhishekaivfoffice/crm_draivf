...
class DLNAddDonorDetailsSecondScreen extends StatelessWidget {
  DLNAddDonorDetailsSecondScreen({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: "DLN Add Donor Lead 2nd screen"),
