...
class STPStaffConvertToCustomerPage extends StatelessWidget {
  const STPStaffConvertToCustomerPage({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: "STP staff convert to customer"),
