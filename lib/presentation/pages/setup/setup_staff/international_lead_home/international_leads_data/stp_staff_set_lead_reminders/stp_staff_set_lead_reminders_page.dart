...
class STPStaffSetLeadRemindersPage extends StatelessWidget {
  const STPStaffSetLeadRemindersPage({super.key});

  @override
  Widget build(BuildContext context) {
    final setleadreminderprovider=Provider.of<INLSetLeadRemindersProvider>(context);
    return Scaffold(
      appBar: CustomAppBar(title: "STP Setup set lead reminders"),
