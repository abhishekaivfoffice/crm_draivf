...
class STPStaffAssignedMemberProfile extends StatelessWidget {
  final AssignedMember member;

  const STPStaffAssignedMemberProfile({super.key, required this.member});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: "STP Staff Assigned Profile"),
      body: Column(
        children: [
          Stack(
