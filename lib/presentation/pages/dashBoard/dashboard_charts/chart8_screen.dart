...
class Chart8Screen extends StatefulWidget {
  const Chart8Screen({super.key});

  @override
  State<Chart8Screen> createState() => _Chart8ScreenState();
}

class _Chart8ScreenState extends State<Chart8Screen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(title: "Chart 8"),
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              Text(
                "Source Walkins (Branch Wise) - Count: $selectedLegendsTotal ",
                style: TextStyle(
              ...
              Column(
                children: [
                  ...
                  DropdownButtonFormField2<String>(
                    ...
                    // ✅ Use branchLocations list instead of chartData
                    items:
                    ...
                    onChanged: (value) {
                      ...
                      _refreshAnimation(); // ✅ Refresh chart animation
                    },
                  ),
                ],
              ),
