...
class Chart3Screen extends StatefulWidget {
  const Chart3Screen({super.key});

  @override
  State<Chart3Screen> createState() => _Chart3ScreenState();
}

class _Chart3ScreenState extends State<Chart3Screen> {
  // ----- sample data -----
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: CustomAppBar(title: "Chart 3"),
