...
class SetupStaffAddNewStaffProvider extends ChangeNotifier {
  ...
  bool get isAdministrator => _isAdministrator;
    bool _isSendWelcomeMail = false;
  bool get isSendWelcomeMail => _isSendWelcomeMail;
  ...
  void setIsAdministrator(bool value) {
    ...
    void setIsSendWelcomeMail(bool value) {
    _isSendWelcomeMail = value;
    notifyListeners();
  }
File? _selectedFile;
