...
class SetupStaffDataProvider extends ChangeNotifier {
   bool _isActive = false; // default
...
List<StaffModel> _users = [
  ...
  StaffModel(
    ...
    email: "sneha.patel@exampleexampleexample.com",
    location: "Chennai",
    role: "Support",
  ...
  StaffModel(
    ...
    location: "Hyderabad",
    role: "Telecaller",
    lastLogin: "12 hrs ago",
    isActive: true,
    imageUrl: "https://randomuser.me/api/portraits/men/6.jpg",
  ),
];

    List<StaffModel> get users => _users;
   List<StaffModel> get currentPageUsers {
